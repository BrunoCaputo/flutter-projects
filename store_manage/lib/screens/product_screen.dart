...
import 'package:store_manage/blocs/product_bloc.dart';
import 'package:store_manage/validators/product_validators.dart';
import 'package:store_manage/widgets/images_widget.dart';
import 'package:store_manage/widgets/product_sizes.dart';
  ...
  void saveProduct() async {
    if (_formKey.currentState.validate()) {
      ...
      _scaffoldKey.currentState.showSnackBar(
        SnackBar(
          content: Text(
            _success ? "Produto salvo!" : "Erro ao salvar produto!",
            style: TextStyle(color: Colors.white),
          ),
          backgroundColor: Colors.pinkAccent,
        ),
