package com.bruno.floating_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        channel.setMethodCallHandler((call, result) -> {
            ...
            case "create":
                ...
                FloatWindow.with(getApplicationContext()).setView(imageView).setWidth(Screen.width, 0.15f)
                        .setHeight(Screen.width, 0.15f).setX(Screen.width, 0.8f).setY(Screen.height, 0.3f)
